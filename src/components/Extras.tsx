  ...
  return (
    <section id={id} className="py-16 bg-gray-800 text-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12 text-blue-400">Extra Features</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {extras.map((extra) => (
            <div key={extra.name} className="flex flex-col bg-gray-700 rounded-lg overflow-hidden">
              ...
              <div className="p-4 flex-grow">
                <p className="text-sm text-gray-300">{extra.description}</p>
              </div>
            </div>
          ))}
        </div>
